  ...
  return (
    <div>
      ...
      <p>
        ...
        types of property of interest, background and skills, overall goals, and
        dislikes.
      </p>
      <br />
      <p>
        The tool will then generate a thesis that can be used to narrow in on
        the most suitable commercial property for the buyer.
      </p>
      <br />
      <p>Let's go!</p>
