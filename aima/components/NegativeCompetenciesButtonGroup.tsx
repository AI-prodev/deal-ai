...
import NegativeButtonGroup from "./NegativeButtonGroup";
import { Button } from "./Button";

interface NegativeCompetenciesButtonGroupProps {
  onSelectedNegativeCompetencies: (commaSeparatedString: string) => void;
}

const NegativeCompetenciesButtonGroup: React.FC<
  NegativeCompetenciesButtonGroupProps
> = ({ onSelectedNegativeCompetencies }) => {
  ...
  const handleSelect = useCallback(
    (selectedButtons: Button[]) => {
      ...
      onSelectedNegativeCompetencies(commaSeparatedString);
    },
    [onSelectedNegativeCompetencies]
  );
  ...
  return (
    <div>
      <NegativeButtonGroup buttons={buttons} onSelect={handleSelect} />
    </div>
  );
};

export default NegativeCompetenciesButtonGroup;
