...
export const DebugLinks: React.FC<DebugLinksProps> = ({}) => {
  ...
  return (
    <>
      {debug && (
        <div>
          <h2 className="-mx-4 mb-1 flex items-center bg-white-light/30 py-3 px-7 font-extrabold dark:bg-dark dark:bg-opacity-[0.08]">
            <svg
          ...
          <li className="menu nav-item">
            ...
            >
              ...
              <div
                className={
                  currentMenu === "component" ? "rotate-90" : "rtl:rotate-180"
                }
              >
                <svg
                  width="16"
          ...
          <li className="menu nav-item">
            ...
            >
              ...
              <div
                className={
                  currentMenu === "datalabel" ? "rotate-90" : "rtl:rotate-180"
                }
              >
                <svg
                  width="16"
        ...
        <div>
          ...
          <li className="menu nav-item">
            ...
            >
              <ul className="sub-menu text-gray-500">
                <li>
                  <Link href="/pages/release-notes">{t("Release Notes")}</Link>
                </li>
                <li>
