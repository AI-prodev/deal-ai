...
const BusinessTable = ({
  ...
  const [initialRecords, setInitialRecords] = useState(
    sortBy(business.requests, "firstName")
  );
  ...
  useEffect(() => {
    if (search === "")
      setInitialRecords(sortBy(business.requests, "firstName"));
    else
      setInitialRecords(() =>
        business.requests.filter(
          item =>
      ...
      <div className="panel">
        <div className="mb-5 flex flex-col gap-5 md:flex-row md:items-center">
          <h5 className="text-lg font-semibold dark:text-white-light">
            ...
            {business?.businessName?.slice(-1) === "s" ? "`" : "`s"} Information
            Requests
          </h5>
