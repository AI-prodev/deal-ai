...
import {
  useLazyDownloadFunnelSalesCSVQuery,
  useListFunnelSalesQuery,
} from "@/store/features/salesApi";
...
const FunnelSales = () => {
  ...
  const {
    ...
    {
      funnelId: query?.funnelId as string,
      page,
      limit: pageSize,
      sort:
  ...
  const [download] = useLazyDownloadFunnelSalesCSVQuery();
            ...
            <>
              <div className="table-responsive  mb-5 ">
                <DataTable
                  highlightOnHover
                  fetching={isFetching}
                  records={invoices?.results || []}
                  columns={columns}
                  totalRecords={invoices?.totalData || 0}
