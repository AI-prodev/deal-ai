      ...
      <div className="shadow-sm">
        <div className="relative flex w-full items-center bg-white px-5 py-2.5 dark:bg-black">
          <div className="horizontal-logo flex items-center justify-between ltr:mr-2 rtl:ml-2">
            ...
            >
              <LogoSVG className="inline w-8 ltr:-ml-1 rtl:-mr-1 fill-black dark:fill-white w-[36px] h-[36px]" />
              <span className="hidden align-middle text-2xl font-semibold transition-all duration-300 ltr:ml-2 rtl:mr-2 dark:text-white-light md:inline">
                deal.ai
              </span>
            </Link>
            <Link
              href={"/apps/ai-apps"}
              className="collapse-icon flex flex-none rounded-full bg-white-light/40 p-2 ltr:ml-2 rtl:mr-2 dark:bg-dark/40 dark:text-[#d0d2d6]"
            >
              <Home2SVG />
            </Link>
          </div>
          ...
          <div className="flex items-center space-x-1.5 ltr:ml-auto rtl:mr-auto rtl:space-x-reverse dark:text-[#d0d2d6] sm:flex-1 ltr:sm:ml-0 sm:rtl:mr-0 lg:space-x-2">
            ...
            <div className="dropdown flex shrink-0">
              {isLoading ? (
                <div
                  className={` flex h-9 w-9 animate-pulse items-center  justify-center rounded-full bg-gray-400 object-cover text-lg text-white`}
                ></div>
              ) : (
                <Dropdown
                  offset={[0, 8]}
                  ...
                  button={
                    profileValue.profileImage ? (
                      ...
                      <div
                        className={`flex h-9 w-9 items-center justify-center rounded-full text-lg text-bkack dark:text-white shadow-[4px_6px_10px_-3px_#bfc9d4] dark:shadow-none ${bgColor}`}
                      >
                        {initials}
                      </div>
                    )
                ...
                >
                  <ul className="w-[230px] !py-0 font-semibold text-dark dark:text-white-dark dark:text-white-light/90">
                    <li>
                      <div className="flex items-center px-4 py-4">
                        {profileValue.profileImage ? (
                          ...
                          <div
                            className={`flex h-10 w-10 items-center justify-center  rounded-md object-cover text-lg text-white ${bgColor}`}
                          >
                            {initials}
                          </div>
                        )}
                    ...
                    <li className="border-t border-white-light dark:border-white-light/10">
                      <Link href="/domains" className="dark:hover:text-white">
...
export default withAuth(Header, ALL_ROLES);
