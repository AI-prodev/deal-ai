        ...
        <div className="flex min-h-screen items-center justify-center dark:bg-dark-dark-light">
          <div className="h-full w-full lg:w-1/2">
            <div className="mx-auto max-w-[480px] p-5 md:p-10">
              <h4 className="mb-2 text-2xl font-bold text-primary md:text-4xl">
                Coming Soon
              </h4>
              <p className="mb-10 text-base font-bold text-white-dark">
              ...
              <form className="mb-5" onSubmit={submitForm}>
                <div className="relative mx-auto max-w-[580px]">
                  ...
                  <input
                    type="email"
                    placeholder="Email"
                    className="form-input py-3 ltr:pl-9 ltr:pr-[100px] rtl:pr-9 rtl:pl-[100px]"
                  />
                  <button
                    type="submit"
                    className="btn btn-primary absolute top-0 rounded-bl-3xl py-2.5 ltr:right-0 rtl:left-0"
                  >
                    Subscribe
                  </button>
                </div>
