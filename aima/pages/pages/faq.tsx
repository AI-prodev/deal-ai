        ...
        <div className="pt-5">
          ...
          <div className="mt-5 space-y-5">
            <div className="rounded-md border border-[#ebedf2] bg-white dark:border-[#191e3a] dark:bg-black ">
              <div
                className={`flex cursor-pointer rounded-t-md p-5  font-semibold ${active === 1 ? "bg-primary/20 text-primary" : ""}`}
                onClick={() => togglePara(1)}
              >
                <span className="text-primary">Getting started</span>
                <div className="flex  ltr:ml-auto rtl:mr-auto">
                  <svg
                    className={`h-5 w-5 ${active === 1 ? "rotate-180" : ""}`}
                    viewBox="0 0 24 24"
                    fill="none"
            ...
            <div className="rounded-md border border-[#ebedf2] bg-white dark:border-[#191e3a] dark:bg-black">
              <div
                className={`flex cursor-pointer rounded-t-md p-5  font-semibold ${active === 2 ? "bg-primary/20 text-primary" : ""}`}
              ...
              >
                ...
                <div className="flex  ltr:ml-auto rtl:mr-auto">
                  <svg
                    className={`h-5 w-5 ${active === 2 ? "rotate-180" : ""}`}
                    viewBox="0 0 24 24"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                  >
            ...
            <div className="rounded-md border border-[#ebedf2] bg-white dark:border-[#191e3a] dark:bg-black">
              <div
                className={`flex cursor-pointer rounded-t-md p-5  font-semibold ${active === 3 ? "bg-primary/20 text-primary" : ""}`}
                onClick={() => togglePara(3)}
              >
                <span className="text-primary">Sidebar not rendering CSS</span>
                <div className="flex  ltr:ml-auto rtl:mr-auto">
                  <svg
                    className={`h-5 w-5 ${active === 3 ? "rotate-180" : ""}`}
                    viewBox="0 0 24 24"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                  >
            ...
            <div className="rounded-md border border-[#ebedf2] bg-white dark:border-[#191e3a] dark:bg-black">
              <div
                className={`flex cursor-pointer rounded-t-md p-5  font-semibold ${active === 4 ? "bg-primary/20 text-primary" : ""}`}
                onClick={() => togglePara(4)}
              >
                <span className="text-primary">Production Level Built</span>
                <div className="flex  ltr:ml-auto rtl:mr-auto">
                  <svg
                    className={`h-5 w-5 ${active === 4 ? "rotate-180" : ""}`}
                    viewBox="0 0 24 24"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                  >
            ...
            <div className="rounded-md border border-[#ebedf2] bg-white dark:border-[#191e3a] dark:bg-black">
              <div
                className={`flex cursor-pointer rounded-t-md p-5  font-semibold ${active === 5 ? "bg-primary/20 text-primary" : ""}`}
                onClick={() => togglePara(5)}
              >
                <span className="text-primary">Compilation Issue</span>
                <div className="flex  ltr:ml-auto rtl:mr-auto">
                  <svg
                    className={`h-5 w-5 ${active === 5 ? "rotate-180" : ""}`}
                    viewBox="0 0 24 24"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                  >
            ...
            <div className="rounded-md border border-[#ebedf2] bg-white dark:border-[#191e3a] dark:bg-black">
              <div
                className={`flex cursor-pointer rounded-t-md p-5  font-semibold ${active === 6 ? "bg-primary/20 text-primary" : ""}`}
              ...
              >
                ...
                <div className="flex  ltr:ml-auto rtl:mr-auto">
                  <svg
                    className={`h-5 w-5 ${active === 6 ? "rotate-180" : ""}`}
                    viewBox="0 0 24 24"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                  >
