  ...
  return (
    <>
      ...
      <div>
        ...
        <div className="pt-5">
          <h2 className="my-5 text-center text-2xl font-bold md:text-5xl">
            Knowledge Base
          </h2>
          ...
          <p className="mb-14 text-center text-base font-semibold">
          ...
          <ul className="md:grid-cols-0 mb-10 grid grid-cols-2 justify-center gap-5 rtl:space-x-reverse md:flex md:gap-0 md:space-x-5">
            <li className="group rounded-md border border-[#ebedf2] bg-white p-4 py-10 text-center hover:shadow-[rgba(145,158,171,0.20)_0px_0px_2px_0px,_rgba(145,158,171,0.12)_0px_12px_24px_-4px] dark:border-[#191e3a] dark:bg-black md:w-[240px]">
              ...
              <h5 className="mt-3 font-bold group-hover:text-primary">
                General
              </h5>
            </li>
            <li className="group rounded-md border border-[#ebedf2] bg-white p-4 py-10 text-center hover:shadow-[rgba(145,158,171,0.20)_0px_0px_2px_0px,_rgba(145,158,171,0.12)_0px_12px_24px_-4px] dark:border-[#191e3a] dark:bg-black md:w-[240px]">
          ...
          <h3 className="mb-5 text-center text-xl font-bold md:text-3xl">
          ...
          <div className="mb-10 space-y-5">
            <div className="rounded-md border border-[#ebedf2] bg-white dark:border-[#191e3a] dark:bg-black ">
              <div
                className={`flex cursor-pointer p-5 font-semibold ${active === 1 ? "text-primary" : ""}`}
              ...
              >
                <svg
                  ...
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-5 w-5 ltr:mr-4 rtl:ml-4"
                >
                  <path
            ...
            <div className="rounded-md border border-[#ebedf2] bg-white dark:border-[#191e3a] dark:bg-black">
              <div
                className={`flex cursor-pointer p-5 font-semibold ${active === 2 ? "text-primary" : ""}`}
            ...
            <div className="rounded-md border border-[#ebedf2] bg-white dark:border-[#191e3a] dark:bg-black">
              <div
                className={`flex cursor-pointer p-5 font-semibold ${active === 3 ? "text-primary" : ""}`}
            ...
            <div className="rounded-md border border-[#ebedf2] bg-white dark:border-[#191e3a] dark:bg-black">
              <div
                className={`flex cursor-pointer p-5 font-semibold ${active === 4 ? "text-primary" : ""}`}
            ...
            <div className="rounded-md border border-[#ebedf2] bg-white dark:border-[#191e3a] dark:bg-black">
              <div
                className={`flex cursor-pointer p-5 font-semibold ${active === 5 ? "text-primary" : ""}`}
            ...
            <div className="rounded-md border border-[#ebedf2] bg-white dark:border-[#191e3a] dark:bg-black">
              <div
                className={`flex cursor-pointer p-5 font-semibold ${active === 6 ? "text-primary" : ""}`}
