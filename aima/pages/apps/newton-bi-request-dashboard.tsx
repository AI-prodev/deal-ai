...
const BusinessInformationRequestsDashboard = () => {
  ...
  const {
    useGetBusinesInformationRequestsByBuyerIdQuery,
  ...
  const {
    ...
    isFetching,
    error,
  } = useGetBusinesInformationRequestsByBuyerIdQuery(sessionData?.id || "");
  ...
  useEffect(() => {
    if (editingBusinessId !== "") {
      router.replace(
        `/apps/newton-bi-request-dashboard?id=${editingBusinessId}`
      );
    }
  }, [editingBusinessId]);
        ...
        <div className="space-y-2 pt-5">
          ...
          {!editingBusinessId ? (
            isError ? (
              ...
              <BuyerBusinessTable
                business={buyerBusinessList?.response || []}
...
export default withAuth(BusinessInformationRequestsDashboard, BUYER_ROLES);
