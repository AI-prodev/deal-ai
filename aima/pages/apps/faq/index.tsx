import FaqForm from "@/components/marketingHooks/FaqForms";
import withAuth from "@/helpers/withAuth";
import { USER_ROLES } from "@/utils/roles";
import { FaqResults } from "@/components/marketingHooks/FaqResults";
      ...
      <div className="p-3">
        ...
        <div className="flex items-center flex-col">
          {storedGeneration ? (
            ...
            <div className="my-3 w-full max-w-lg pt-2">
              <div className="mb-8">
                <h2 className="text-2xl font-bold">FAQs</h2>
              </div>
...
export default withAuth(Faq, USER_ROLES, "ai-platform");
