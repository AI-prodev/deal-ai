...
const Wizards = () => {
  ...
  useEffect(() => {
    dispatch(setPageTitle("Thesis Builder"));
  });
            ...
            <div className="mb-5">
              <div className="inline-block w-full">
                <ul className="mb-5 grid grid-cols-3 text-center">
                  ...
                  <li>
                    <div
                      className={`${activeTab === 2 ? "!bg-primary text-white" : ""} block rounded-full bg-[#f3f2ee] p-2.5 dark:bg-[#1b2e4b]`}
                  ...
                  <li>
                    <div
                      className={`${activeTab === 3 ? "!bg-primary text-white" : ""} block rounded-full bg-[#f3f2ee] p-2.5 dark:bg-[#1b2e4b]`}
                  ...
                  <div className="mb-5">
                    {activeTab === 1 && (
                      <div>
                        ...
                        <br />
                        <p>
                          In the next page, you'll enter information about the
                          investor, including previous business acquisitions (if
                          any), core competencies, target verticals, negative
                          areas, and hobbies.
                        </p>
                        <br />
                        <p>
                          The tool will then generate an buying thesis that can
                          be used to narrow in on the most suitable businesses
                          for the investor. Let's go!
                        </p>
                      </div>
                    )}
                  </div>
              ...
              <div className="inline-block w-full">
                <ul className="mb-5 grid grid-cols-3">
                  ...
                  <li>
                    ...
                    <span
                      className={`mt-2 block text-center ${activeTab2 === 3 ? "text-primary " : ""}`}
                    >
                      Success
                    </span>
                  </li>
                ...
                <div className="relative z-[1]">
                  ...
                  <ul className="mb-5 grid grid-cols-3">
                    <li className="mx-auto">
                      ...
                      <span
                        className={`${activeTab4 === 1 ? "text-primary " : ""}text-center mt-2 block`}
                      >
                        Home
                      </span>
                    </li>
                    <li className="mx-auto">
                      ...
                      <span
                        className={`${activeTab4 === 2 ? "text-primary " : ""}text-center mt-2 block`}
                      >
                        About
                      </span>
                    </li>
                    <li className="mx-auto">
                      ...
                      <span
                        className={`${activeTab4 === 3 ? "text-primary " : ""}text-center mt-2 block`}
                      >
                        Success
                      </span>
                    </li>
                ...
                <div className="relative z-[1]">
                  ...
                  <ul className="mb-5 grid grid-cols-3">
                    <li className="mx-auto">
                      ...
                      <span
                        className={`${activeTab6 === 1 ? "text-primary " : ""}text-center mt-2 block`}
                      >
                        Home
                      </span>
                    </li>
                    <li className="mx-auto">
                      ...
                      <span
                        className={`${activeTab6 === 2 ? "text-primary " : ""}text-center mt-2 block`}
                      >
                        About
                      </span>
                    </li>
                    <li className="mx-auto">
                      ...
                      <span
                        className={`${activeTab6 === 3 ? "text-primary " : ""}text-center mt-2 block`}
                      >
                        Success
                      </span>
                    </li>
